...
<head>
    ...
    <!-- Le styles -->
    <script type="text/javascript" src="/Sdorms/Public/assets/js/jquery.min.js"></script>
    ...
    <link rel="stylesheet" href="/Sdorms/Public/assets/css/signin.css">
    ...
    <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="/Sdorms/Public/assets/ico/minus.png">
</head>
...
<script type="text/javascript" src="/Sdorms/Public/assets/js/map/gmap3.js"></script>
