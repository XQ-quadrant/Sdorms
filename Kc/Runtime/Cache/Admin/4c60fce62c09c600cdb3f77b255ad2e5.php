...
<head>
	...
	<link href="/Sdorms/Public/assets/js/iCheck/flat/all.css" rel="stylesheet">
	<link href="/Sdorms/Public/assets/js/iCheck/line/all.css" rel="stylesheet">

	<link href="/Sdorms/Public/assets/js/colorPicker/bootstrap-colorpicker.css" rel="stylesheet">
	<link href="/Sdorms/Public/assets/js/switch/bootstrap-switch.css" rel="stylesheet">
	<link href="/Sdorms/Public/assets/js/validate/validate.css" rel="stylesheet">
	<link href="/Sdorms/Public/assets/js/idealform/css/jquery.idealforms.css" rel="stylesheet">">-->
...
&ndash;&gt;
		...
		<div class="container-fluid paper-wrap bevel tlbr">
							...
							<div class="body-nest" id="horizontal">
								<div class="form_center">
									<form role="form" id="form-submit" class="form-horizontal">
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label" for="title">商品标题</label>
											<div class="col-sm-6">
												<input type="text" id="title" name="title" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label" for="address">地址描述</label>
											<div class="col-sm-6">
												<input type="text" id="address" name="address" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label" for="price">价格</label>
											<div class="col-sm-6">
												<input type="text" id="price" name="price" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label" for="connect">联系方式</label>
											<div class="col-lg-10">
												<input type="email" placeholder="电话" id="connect" name="connect" class="form-control">
												<p class="help-block">Example block-level help text here.</p>
											</div>
										</div>
										<div class="form-group">

											<label class="col-lg-2 col-sm-2 control-label" for="myEditor">商品详情</label>
											<div class="col-lg-8">
												<textarea id="myEditor" name="content" type="text/plain" >
												</textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 col-sm-2 control-label" for="exampleInputFile">图</label>
											<div class="col-lg-10">
												<input type="file" id="exampleInputFile">
												<p class="help-block">贴图</p>
											</div>
										...
										<div class="form-group">
											<div class="col-lg-offset-2 col-lg-10">
												<div class="checkbox">
													<label>
														<input type="checkbox">我遵守《XXXXXX》
													</label>
												</div>
											</div>
										</div>
									...
									<div class="form-group">
										<div class="col-lg-offset-2 col-lg-10">
											<button class="btn btn-danger" id="submit" type="submit"> 发 布 </button>
										</div>
									</div>
								</div>
			...
			<script>
				$('#submit').click(function () {
					...
					$.ajax({
						url: '/Sdorms/index.php/Admin/Article/addAtc/cate/<?php echo ($cate); ?>/mid/<?php echo ($mid); ?>',
						type: 'post',//提交的方式
						dataType: 'json',
						...
						success: function (rdata) {
							...
							if (rdata.status == 1) {
								window.location.href = '/Sdorms/index.php/Admin/Article/index/cate/29'; //document.referrer;
							}
							if(rdata.status != 1){
								$('#submit').text('发布')
							}
	...
	<script type="text/javascript" src="/Sdorms/Public/assets/js/iCheck/jquery.icheck.js"></script>
	<script type="text/javascript" src="/Sdorms/Public/assets/js/switch/bootstrap-switch.js"></script>

	<!--  PLUGIN -->
	<script>
		var ue = UE.getEditor('myEditor');  //Ueditor初始化
